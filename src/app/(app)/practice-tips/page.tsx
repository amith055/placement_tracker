...
export default function PracticeTipsPage() {
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Skill Improvement Focus</CardTitle>
          <CardDescription>
            Select or type your weak areas to get personalized AI-based practice tips.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent>
          <form action={formAction} className="space-y-6">
            <div className="space-y-4">
              ...
              {/* Custom Area Textbox */}
              <div className="mt-4">
                <Label htmlFor="customArea" className="font-medium">
                  Other area (optional)
                </Label>
                <Input
                  id="customArea"
          ...
          {state.message === 'success' && state.tips ? (
            ...
            <div className="flex h-full items-center justify-center rounded-lg border border-dashed">
              <div className="text-center text-muted-foreground">
                ...
                <p className="mt-2 text-sm">Select or type your weak areas, then click “Generate Tips”.</p>
              </div>
            </div>
          )}
        </CardContent>
